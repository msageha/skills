...
the server performs the router login itself (lazy on first call, with up to
1 automatic retry on session expiry). Interactive docs: `https://deco.msageha.net/docs`.
